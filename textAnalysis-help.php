            ...
            <div class="row" id="image_text">
              <div class="solo_pane">
                <div id="introduction">
                  ...
                  <p>This page is designed to help contextualize the various text analysis tools found on this website, and define some related terms.  This is not meant to be a comprehensive guide to textual analysis, merely insight and clarificiation of tools and terms used on these pages.</p>

                  <p>This experimental tool, "textAnalysis", was created to work specifically with texts digitized by the Wayne State University Libraries.  These texts are complex digital objects, part of the library's digital collections.  Each text is comprised of page image scans, OCR'ed text in gently marked-up HTML form, and XML metadata providing spatial coordinates of each word on the page.  These tools use the page images and the OCR'ed text to create shared annotations and perform textual analysis.</p>

                  <p>As an experimental tool, still very much in beta, the tools and analysis are meant to be functional first, visually appealing second.  As an early exploration of textual analysis and the affordances that digital texts provide, using digitized texts here in the Library, we warmly welcome any <a href="mailto:libwebmaster@wayne.edu">comments, feedback, or suggestions</a>.</p>
                ...
                <div id="annotation_help">
                  ...
                  <p>It is worth noting some of the OCR'ed text may not be 100% accuarate, this is a reality of digitized text.  Though we do have the capability to create 100% accurate text, and most certainly do for some projects and resources, it is not a requirement for each text.  Users have probably experienced this cutting and pasting from digitized PDF's, but it can be more surprising seeing that text right along next to the page image.</p>
                  ...
                  <table class="table table-hover">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>Here, "Collocations" are calculated finding common two-word combinations, also known as "bi-grams", where each word is longer than 3 characters, appearing more than twice in the text, with stopwards removed.</td>
                      </tr>
                      <tr>
